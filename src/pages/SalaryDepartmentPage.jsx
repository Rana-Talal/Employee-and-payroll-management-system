...
const EmployeeTabsPage = () => {
  ...
  const handleViewDetails = (employee) => {
    navigate(`/salary-view/${employee.id}`);
  };
  ...
  return (
    <div className="p-4 sm:p-6 bg-gradient-to-br from-emerald-50 to-teal-50 min-h-screen">
      {/* العنوان الرئيسي */}
      <div className="mb-6">
        <h1 className="text-3xl sm:text-4xl font-bold text-gray-800 mb-2">قسم الحسابات</h1>
        <p className="text-gray-600">إدارة ومتابعة رواتب الموظفين</p>
      </div>
        ...
        <form onSubmit={handleSearchSubmit}>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-3 mb-3">
            <input
              ...
              className="px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 text-right"
            />
              ...
              <table className="w-full">
                ...
                <tbody className="divide-y divide-gray-200">
                  {displayedEmployees.map((emp, index) => (
                    <tr key={emp.id} className="hover:bg-emerald-50 transition">
                      ...
                      <td className="px-4 py-3">
                        <div className="flex gap-1 justify-center">
                          <button
                            ...
                            className="bg-emerald-600 text-white px-3 py-1.5 rounded-lg text-xs hover:bg-emerald-700 transition shadow hover:shadow-md"
                            title="عرض التفاصيل"
                          >
                            📄
                          </button>
                          <button
                            ...
                            className="bg-teal-500 text-white px-3 py-1.5 rounded-lg text-xs hover:bg-teal-600 transition shadow hover:shadow-md"
                            title="تعديل الراتب"
                          >
                            ✏️
                          </button>
