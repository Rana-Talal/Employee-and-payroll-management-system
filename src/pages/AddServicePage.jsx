...
export default function AddServicePage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch(`${BASE_URL}/EmployeeServiceRecord`, {
        method: "POST",
        headers: {
          ...getAuthHeaders(),
      ...
      if (!res.ok) throw new Error("فشل في إضافة الخدمة");
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-green-50 to-emerald-50 p-6" dir="rtl">
      ...
      <div className="mb-8">
        <div className="bg-gradient-to-r from-green-600 to-emerald-600 rounded-2xl shadow-xl p-8 text-white">
          <h1 className="text-4xl font-black mb-2">إضافة خدمة جديدة</h1>
          <p className="text-green-100 text-lg">استناداً لأحكام قرار مجلس الوزراء رقم (315) لسنة 2019</p>
        </div>
      </div>
