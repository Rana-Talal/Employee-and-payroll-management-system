...
export default function HRDashboard() {
    ...
    const fetchDashboardData = async () => {
      try {
        ...
        setStats({
          ...
          activeEntitlements: 0, // TODO: جلب من API
          activeDeductions: 0, // TODO: جلب من API
  ...
  const SlideOverPanel = () => {
    ...
    return (
      ...
      >
        {/* Header */}
        <div className="bg-gradient-to-l from-green-600 to-green-500 text-white p-5 flex items-center justify-between shadow-lg flex-shrink-0">
                  ...
                  {panelData.length === 0 ? (
                    ...
                    panelData.map((branch) => (
                      <div
                        ...
                        className="bg-gradient-to-r from-green-50 to-white p-4 rounded-lg border border-green-100 hover:border-green-300 hover:shadow-md transition-all cursor-pointer group"
                      >
                        <div className="flex items-center justify-between">
                          ...
                          <div className="text-green-600 group-hover:translate-x-[-4px] transition-transform">
                            ←
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="bg-green-50 p-4 rounded-lg mb-4">
                    ...
                    <div className="grid grid-cols-2 gap-3 text-sm">
                      <div className="bg-white p-3 rounded">
                        ...
                        <span className="font-bold text-green-600">{branchDepartments.length}</span>
                      </div>
                      <div className="bg-white p-3 rounded">
                        <span className="text-gray-600">الموظفين: </span>
                        <span className="font-bold text-blue-600">{selectedBranch.employeeCount}</span>
                      </div>
                    </div>
                  </div>
      ...
      <aside className="w-80 bg-white border-l border-gray-200 shadow-lg flex-shrink-0 sticky top-0 h-screen overflow-y-auto">
        <div className="p-6">
          ...
          <div className="mb-6 pb-4 border-b border-gray-200">
            ...
            <p className="text-sm text-gray-500 mt-1">إدارة الموظفين والمخصصات</p>
          </div>
          ...
          <nav className="space-y-2">
            ...
            >
              <span className="text-lg group-hover:scale-110 transition-transform">💰</span>
              <span>المخصصات والاستقطاعات</span>
            </button>
            ...
            >
              <span className="text-lg group-hover:scale-110 transition-transform">📋</span>
              <span>إدارة احتساب الخدمة</span>
            </button>

            {/* إدارة كتب الشكر والترفيعات */}
            <button
              onClick={() => navigate("/appreciation-letters")}
              className="w-full text-right px-3 py-2.5 rounded-lg bg-gray-50 hover:bg-gray-100 text-gray-700 text-sm font-medium transition flex items-center gap-2 group"
            >
              <span className="text-lg group-hover:scale-110 transition-transform">🏆</span>
              <span>كتب الشكر والترفيعات</span>
            </button>
            ...
            <div className="px-2 py-1">
              <p className="text-xs font-bold text-gray-500 mb-2">⚙️ الإعدادات</p>
            </div>
            ...
            >
              <span className="text-lg group-hover:scale-110 transition-transform">🎯</span>
              <span>إدارة المناصب</span>
            </button>

            <button
              onClick={() => navigate("/salary-scale")}
              className="w-full text-right px-3 py-2.5 rounded-lg bg-gray-50 hover:bg-gray-100 text-gray-700 text-sm font-medium transition flex items-center gap-2 group"
            >
              <span className="text-lg group-hover:scale-110 transition-transform">📊</span>
              <span>إدارة سلم الرواتب</span>
            </button>
          </nav>
        </div>
      </aside>
